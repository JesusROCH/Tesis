...
import com.example.tesis.Exception.PathNotFoundException;
import com.example.tesis.Model.Edge;
import com.example.tesis.Model.Graph;
import com.example.tesis.Model.Vertex;
...
public class AlgoritmoDijkstra {
    ...
    public AlgoritmoDijkstra(Graph graph) {
        this.edges = new ArrayList<>(graph.getEdges());
    }

    public AlgoritmoDijkstra execute(Vertex source) throws PathNotFoundException {
        this.source = source;
